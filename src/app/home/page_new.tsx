...
import { Upload, Mic, MicOff, Send, LogOut, BarChart3 } from 'lucide-react';
                  ...
                  <div className="space-y-4">
                    {advice.map((item, index) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-gray-800 font-medium mb-3" style={{ fontFamily: 'Noto Sans Kannada, serif' }}>
                          {item.kannadaText}
                        </p>
